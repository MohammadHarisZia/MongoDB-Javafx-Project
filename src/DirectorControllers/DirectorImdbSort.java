    ...
    public void initialize(){
        ...
        try {
            ...
            try( MongoClient mongoClient = new MongoClient(mongo)) {
                ...
                FindIterable<Document> iterDoc = collection.find(query).projection(Projections.fields(Projections.include("title","year","runtime","plot","type","directors","imdb.rating","imdb.votes","countries","genres"))).sort(new BasicDBObject("imdb.rating",-1)).limit(500);
